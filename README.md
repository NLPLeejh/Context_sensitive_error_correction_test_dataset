...
오류 유형|예<br>(원본단어 /<br>오류어)|설명
:---:|:---:|---
입력<br>누락|major / maor|사용자가 알파벳 입력을 누락한 경우입니다.
오류<br>알파벳<br>추가 <br> 입력|this / thjis|사용자가 단어에서 입력 할 알파벳 이외의 입력을 한 경우입니다. <br>대부분 오류 알파벳의 등장 좌/우의 알파벳 주위 키보드에서 나타날 확률이 높습니다.
