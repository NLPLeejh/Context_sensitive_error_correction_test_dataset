...
|오류 유형| <h6> 예 <br> (원본단어 / <br> 오류어) </h6> |  설명  |
|:---:|:------------:|---|
|입력 누락|major / maor|사용자가 알파벳 입력을 누락한 경우입니다.|
|오류 알파벳 추가 <br> 입력|this / thjis|사용자가 단어에서 입력 할 알파벳 이외의 입력을 한 경우입니다. 대부분 오류 알파벳의 등장 좌/우의 알파벳 주위 키보드에서 나타날 확률이 높습니다.|
...
|알파벳 입력 순서 <br> 오류|atlanta / altanta|연속으로 입력되는 알파벳의 순서가 사용자의 실수에 의해서 바뀌는 경우입니다.|
